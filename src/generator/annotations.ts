...
export const DTO_ALL_CUSTOM = /@DtoAllCustom/;
export const DTO_CREATE_CUSTOM = /@DtoCreateCustom/;
export const DTO_UPDATE_CUSTOM = /@DtoUpdateCustom/;
export const DTO_ENTITY_CUSTOM = /@DtoEntityCustom/;
export const DTO_CUSTOM = /@DtoCustom/;
